// Generated by scripts/sync-pokedex-data.ts from Solodex pokedex.js ["FireRed and LeafGreen"] — do not edit, run `npm run sync-pokedex`.
window.pokedexData = window.pokedexData || {};
window.pokedexData["FireRed and LeafGreen"] = {
    "Bulbasaur": {
        "species": "Bulbasaur",
        "rom_id": 1,
