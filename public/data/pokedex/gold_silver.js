// Generated by scripts/sync-pokedex-data.ts from Solodex pokedex.js ["Gold and Silver"] — do not edit, run `npm run sync-pokedex`.
window.pokedexData = window.pokedexData || {};
window.pokedexData["Gold and Silver"] = {
    "Bulbasaur": {
        "species": "Bulbasaur",
        "rom_id": 1,
